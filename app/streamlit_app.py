...
from common import SAMPLE_SIZE, RANDOM_STATE, get_explainer_cached, load_mappings_cached, load_model_cached, load_test_with_predictions
...
with st.expander(":question: Comment utiliser cette application ?", expanded=False):
    st.markdown(
        ...
        Une vue d'ensemble (volumes, tendances, performance du modèle) est disponible dans
        la page **Dashboard**, accessible dans le menu à gauche.
        """
    )
